...
class EpocaCosmeticosAdapter(SiteAdapter):
    """Loja especializada em cosmético/beleza (VTEX) - cobre o dermocosmético
    genérico que as bases farma e as farmácias nem sempre têm ficha
    completa."""
    ...
    def search(self, ean):
        ...
        try:
            r = s.get(
                f"https://www.epocacosmeticos.com.br/api/catalog_system/pub/products/search?fq=alternateIds_Ean%3A{ean}",
                timeout=15,
            )
