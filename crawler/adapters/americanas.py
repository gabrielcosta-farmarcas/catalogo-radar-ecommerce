...
class AmericanasAdapter(SiteAdapter):
    """Marketplace generalista (VTEX) - cobre categoria fora do território
    de farmácia (suplemento, casa, brinquedo, papelaria, alimento) que os
    demais adapters (todos farmácia) não veem."""
    ...
    def search(self, ean):
        ...
        try:
            r = s.get(
                f"https://www.americanas.com.br/api/catalog_system/pub/products/search?fq=alternateIds_Ean%3A{ean}",
                timeout=15,
            )
